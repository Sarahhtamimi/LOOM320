...
<head>
  ...
  <style>
    :root {
      ...
      --muted: #8f7d77;
      --line: #eaded8;
      --shadow: 0 14px 35px rgba(89, 63, 55, 0.08);
    }
    ...
    * {
    ...
    body {
      ...
      background: linear-gradient(to bottom, #fcf8f5, #f5ece7);
      color: var(--text);
    }
    ...
    .hero-overlay {
      width: 100%;
      padding: 70px 7%;
      background: linear-gradient(to top, rgba(37, 24, 20, 0.72), rgba(37, 24, 20, 0.18), transparent);
      color: white;
    }
    ...
    .blog-btn {
      display: inline-block;
      text-decoration: none;
      background: linear-gradient(135deg, #d8ab9d, #b98272);
      color: white;
      padding: 12px 18px;
      border-radius: 999px;
      font-size: 14px;
      font-weight: 600;
      box-shadow: 0 10px 22px rgba(185, 130, 114, 0.22);
      cursor: pointer;
      border: none;
    }
...
<header class="header">
  ...
  <section class="hero">
    <div class="hero-overlay">
      <span class="hero-tag">LOOM Journal</span>
      <h1>Fashion, but<br>more conscious.</h1>
      <p>
        Explore thoughtful articles about sustainable fashion, second-use clothing, and mindful wardrobe choices
  ...
  <section class="section-head">
    ...
    <p>
      Discover curated blog posts that make sustainable fashion easier to understand, more elegant to follow, and more
